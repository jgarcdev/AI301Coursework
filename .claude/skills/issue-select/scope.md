...
I have used the following languages: Python, C, Java, JavaScript, and Zig.
I want to avoid issues that require deep understanding of the entire architecture of the project.